...
SELECT COUNT(*) FROM TB_BOARD WHERE BOARD_GROUP_NUM =
		(SELECT BOARD_GROUP_NUM FROM TB_BOARD WHERE BOARD_NUM = 1) AND BOARD_DELETE_CHECK = 'N'

		
		SELECT COUNT(*) FROM TB_BOARD WHERE BOARD_GROUP_NUM = (SELECT BOARD_GROUP_NUM FROM TB_BOARD WHERE BOARD_NUM = 1) AND BOARD_DELETE_CHECK = 'N'
