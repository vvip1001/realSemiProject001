...
,'1234','TEST@NAVER.COM','N','ADMIN',SYSDATE,SYSDATE,0,001,'EMPTY','EMPTY');

SELECT * FROM TB_USER WHERE USER_ID ='ADMIN@NAVER.COM' AND USER_PW='1234' AND USER_DEACT= 'N'

INSERT INTO TB_GROUP VALUES(001,'ADMIN','TEST1');
...
(
    USER_ID               VARCHAR2(100)     NOT NULL,
    BOARD_GENDER		  VARCHAR2(5)       NOT NULL,
