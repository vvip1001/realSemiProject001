...
SELECT CAL_NUM, GROUP_NUM, CAL_TITLE, CAL_CONTENT, CAL_TIME, CAL_DATE
  	FROM TB_CAL WHERE CAL_NUM = 2 AND GROUP_NUM = 1234

UPDATE TB_CAL 
  	SET CAL_TIME = '202001251500' 
  	WHERE CAL_NUM = 1 AND GROUP_NUM = 1234 
  	
INSERT INTO TB_CAL VALUES 
  	(TB_CAL_SEQ.NEXTVAL, 1234, '테스팅', '테스트', '202001201200', SYSDATE)
