...
,'1234','USER@NAVER.COM','N','USER',SYSDATE,SYSDATE,0,null,'EMPTY','EMPTY');
--회원정보 테이블
...
ALTER TABLE TB_USER ADD CONSTRAINT TB_USER_GROUP_NUM_UN UNIQUE (GROUP_NUM);
...
DROP TABLE TB_GROUP CASCADE CONSTRAINT	
